...
const styles = StyleSheet.create({
  ...
  iconWrap: {
    ...
    backgroundColor: '#EDFBF2', borderWidth: 1.5,
    borderColor: G.border, justifyContent: 'center',
    alignItems: 'center', alignSelf: 'center', marginBottom: 24,
  },
  iconEmoji: { fontSize: 32 },

  title:    { fontSize: 26, fontWeight: '800', color: G.text, textAlign: 'center', marginBottom: 8 },
  subtitle: { fontSize: 14, color: G.sub, textAlign: 'center', lineHeight: 20, marginBottom: 32 },
  ...
  inputRow: {
    ...
    paddingHorizontal: 14, paddingVertical: Platform.OS === 'ios' ? 15 : 4,
    marginBottom: 6, borderWidth: 1.5, borderColor: G.border,
  },
  ...
  fieldError:   { color: G.error, fontSize: 12, marginBottom: 14, fontWeight: '500' },
  ...
  successTitle: { fontSize: 24, fontWeight: '800', color: G.text, marginBottom: 12 },
  successBody:  { fontSize: 14, color: G.sub, textAlign: 'center', lineHeight: 22, marginBottom: 8 },
