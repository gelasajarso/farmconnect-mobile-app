...
const ROLES: {
...
}[] = [
  {
    ...
    label: "Farmer",
    emoji: "🌾",
    desc: "List & sell your produce",
  },
  {
    value: "MERCHANT",
    label: "Merchant",
    emoji: "🛒",
    desc: "Buy farm products in bulk",
  },
  {
    value: "DELIVERY",
    label: "Delivery Agent",
    emoji: "🚚",
    desc: "Deliver orders to buyers",
  },
];
    ...
    >
      ...
      >
        ...
        <View style={styles.content}>
          ...
          <View
            style={[styles.inputRow, errors.name ? styles.inputError : null]}
          >
          ...
          <View
            style={[styles.inputRow, errors.email ? styles.inputError : null]}
          >
            <Text style={styles.inputIcon}>✉</Text>
            <TextInput
              style={styles.input}
          ...
          <View
            style={[styles.inputRow, errors.confirm ? styles.inputError : null]}
          >
            <Text style={styles.inputIcon}>🔒</Text>
            <TextInput
              style={styles.input}
